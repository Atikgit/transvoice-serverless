...
def load_models():
    ...
    if model is None:
        print(f"--- Sherpa-ONNX Version: {sherpa_onnx.__version__} ---") # ভার্সন চেক
...
def get_tts_engine(lang_code):
    ...
    print(f"📂 Loading from: {target_folder}")
    ...
    try:
        # --- এখানেই ফিক্স করা হয়েছে ---
        # কোনো এক্সট্রা আর্গুমেন্ট নেই, শুধু যা দরকার তাই দিচ্ছি
        ...
        print(f"✅ Engine Loaded: {lang_code}")
        return engine
...
def handler(job):
    ...
    try:
        ...
        if engine:
            # এখানেও প্যারামিটার কমানো হয়েছে
            ...
            return {"text_out": text, "error": "TTS Engine Failed"}
